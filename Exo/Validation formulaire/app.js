//nth child permet de cibler le premier enfant de sa portee . ca s'appelle des ciblings
...
inpMail.addEventListener('input', (e) => {
    ...
    if (e.target.value.search(regexEmail) === 0){
        ...
        // search nous permet de verifier que notre chaine de caractere e.target
...
let valeurInp;
// tous les caracteres qui ne sont pas des lettres miniscules et majiscules sont interdits
const specialCar = /[^a-zA-Z0-9]/;
// i veut insensible a la casse
